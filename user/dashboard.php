...
SELECT COUNT(*) as t FROM bookings WHERE user_id='$user_id'
"))['t'];

$pending = mysqli_fetch_assoc(mysqli_query($conn,"
SELECT COUNT(*) as t FROM bookings WHERE user_id='$user_id' AND status='pending'
"))['t'];

$completed = mysqli_fetch_assoc(mysqli_query($conn,"
SELECT COUNT(*) as t FROM bookings WHERE user_id='$user_id' AND status='accepted'
"))['t'];
...
<a href="/localserve/user/dashboard.php" class="active">
...
<p>Book and manage your services easily</p>
</div>
